...
describe CoursesController do
  describe "POST create" do
    it "redirects to new if input is invalid" do
      params = create_params(course_id: -3)
      post :create, course: params 
      expect(response).to redirect_to(new_course_path)
    end

    context "if successful," do
      params = create_params(subject: "CSCI", course_id: 3333, name: "Test")
  ...
  describe "PATCH update" do
    it "redirects to edit if input is invalid" do
      params = create_params(subject: "TEST", course_id: 1337, name: "Editz")
    ...
    context "if successful," do
      params = create_params(subject: "FEAR", course_id: 666, name: "Satanic Panic")
      course = Course.create(params)
      params[:id] = course.id
      ...
      it "updates the tuple" do
        patch :update, id: params[:id], course: params
        expect(Course.where(id: params[:id])[0].course_capacity).to eq(20)
      end
    end
  end
end
